...
folder are mapped to the application's root namespace, 'InterviewApp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'InterviewApp' in the same way
as `"InterviewApp/sass/src"`.
